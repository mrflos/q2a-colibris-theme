...
class qa_html_theme extends qa_html_theme_base
{
    ...
    private $welcome_widget_class = '';
    private $ask_search_box_class = '';
    ...
    public function head_css()
    {
        ...
        // add Montserrat font CSS file from Google Fonts
        $this->content['css_src'][] = '//fonts.googleapis.com/css?family=Montserrat:400,700';
    ...
    function nav_list($navigation, $class, $level=null)
        {
            ...
            if ($class=='nav-main') {
                $new_order = array('ask','questions','unanswered','tag','user','admin');
                $temp_nav = array();
    ...
    public function attribution()
    {
        ...
        $this->output(
            ...
            'Colibris Theme par <a href="http://www.florian-express.info">mrflos</a>',
            '</div>'
        );
        parent::attribution();
    }
